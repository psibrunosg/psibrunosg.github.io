          ...
          <AnimatePresence mode="wait">
            ...
            {etapa === "resultado" && (
              <motion.div key="resultado" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center">
                ...
                <h2 className="text-2xl font-semibold text-[var(--c-text)] mb-4" style={{ fontFamily: "var(--font-heading)" }}>Resultado do PHQ-9</h2>
                ...
                <div className="space-y-3 mb-8 max-w-xs mx-auto">
                  <button onClick={() => baixarPDF(dadosPDF)} className="w-full flex items-center justify-center gap-2 px-6 py-3 rounded-full bg-[var(--c-accent)] text-white font-medium hover:opacity-90 transition-opacity">
