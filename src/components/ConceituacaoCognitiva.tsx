...
export function ConceituacaoCognitiva({ respostas }: { respostas: Resposta[] }) {
  ...
  async function encerrarSessao() {
    ...
    try {
      ...
      setChatErro(e instanceof Error ? e.message : "Erro ao encerrar sessão.");
    } finally {
  ...
  async function enviarMensagemChat() {
    ...
    try {
      ...
      setChatErro(e instanceof Error ? e.message : "Erro ao conversar com a IA.");
    } finally {
  ...
  async function salvarAnexo(tipo: "pdf" | "texto", conteudo: string, nomeArquivo?: string) {
    ...
    try {
      ...
      setAnexoErro(e instanceof Error ? e.message : "Erro ao salvar referência.");
    } finally {
