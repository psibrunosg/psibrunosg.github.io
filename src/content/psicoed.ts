...
export const territorios: Territorio[] = [
  ...
  {
    id: "mundos-tematicos",
    titulo: "Mundos Temáticos",
    descricaoCurta: "Crenças, distorções, esquemas e modos explicados por elencos de personagens — Mundo Torajo, Demon Slayer e Jujutsu Kaisen.",
    icone: "gem",
    rota: "/psicoeducacao/mundos",
    status: "disponivel",
    posicao: { x: 50, y: 78 },
  },
];
