...
export const territorios: Territorio[] = [
  ...
  {
    id: "crencas-centrais-demon-slayer",
    titulo: "Crenças Centrais · Demon Slayer",
    descricaoCurta: "As raízes profundas da nossa mente — explicadas pelos caçadores e onis de Demon Slayer.",
    icone: "gem",
    rota: "/psicoeducacao/demon-slayer/crencas",
    status: "disponivel",
    posicao: { x: 5, y: 50 },
  },
  {
    id: "distorcoes-demon-slayer",
    titulo: "Distorções Cognitivas · Demon Slayer",
    descricaoCurta: "Os 12 principais erros de pensamento — explicados pelos personagens de Demon Slayer.",
    icone: "scale",
    rota: "/psicoeducacao/demon-slayer/distorcoes",
    status: "disponivel",
    posicao: { x: 38, y: 8 },
  },
  {
    id: "esquemas-demon-slayer",
    titulo: "Esquemas Iniciais · Demon Slayer",
    descricaoCurta: "As feridas emocionais profundas através das quais enxergamos o mundo — explicadas por Demon Slayer.",
    icone: "eye",
    rota: "/psicoeducacao/demon-slayer/esquemas",
    status: "disponivel",
    posicao: { x: 72, y: 50 },
  },
  {
    id: "modos-demon-slayer",
    titulo: "Modos do Esquema · Demon Slayer",
    descricaoCurta: "As máscaras e estados de humor que assumimos nos momentos difíceis — explicados por Demon Slayer.",
    icone: "layers",
    rota: "/psicoeducacao/demon-slayer/modos",
    status: "disponivel",
    posicao: { x: 95, y: 15 },
  },
  {
    id: "crencas-centrais-jujutsu-kaisen",
    titulo: "Crenças Centrais · Jujutsu Kaisen",
    descricaoCurta: "As raízes mais profundas que sustentam nossos pensamentos — explicadas por Jujutsu Kaisen.",
    icone: "gem",
    rota: "/psicoeducacao/jujutsu-kaisen/crencas",
    status: "disponivel",
    posicao: { x: 40, y: 95 },
  },
  {
    id: "distorcoes-jujutsu-kaisen",
    titulo: "Distorções Cognitivas · Jujutsu Kaisen",
    descricaoCurta: "Os 12 principais erros de pensamento — explicados pelos feiticeiros de Jujutsu Kaisen.",
    icone: "scale",
    rota: "/psicoeducacao/jujutsu-kaisen/distorcoes",
    status: "disponivel",
    posicao: { x: 8, y: 30 },
  },
  {
    id: "esquemas-jujutsu-kaisen",
    titulo: "Esquemas Iniciais · Jujutsu Kaisen",
    descricaoCurta: "As marcas que o trauma deixa na alma — explicadas pelo universo de Jujutsu Kaisen.",
    icone: "eye",
    rota: "/psicoeducacao/jujutsu-kaisen/esquemas",
    status: "disponivel",
    posicao: { x: 95, y: 92 },
  },
  {
    id: "modos-jujutsu-kaisen",
    titulo: "Modos do Esquema · Jujutsu Kaisen",
    descricaoCurta: "As máscaras de proteção e defesa que usamos no dia a dia — explicadas por Jujutsu Kaisen.",
    icone: "layers",
    rota: "/psicoeducacao/jujutsu-kaisen/modos",
    status: "disponivel",
    posicao: { x: 60, y: 25 },
  },
];
