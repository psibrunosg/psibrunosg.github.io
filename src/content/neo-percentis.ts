...
export const neoPercentilFacetas: Partial<Record<NeoPISexo, Record<string, number[]>>> = {
  masculino: {
    ...
    // Anexo 5 (eixo O, 20 níveis). Contiguidade fecha em O3, O4, O5 e O6.
    // ⚠️ O1 e O2: P50 sai vazio nas duas, com P45 = 19 e P60 = 21 — o bruto
    //    20 fica fora de qualquer faixa. Mantidos como impressos (o lookup
    //    joga o 20 no P45, que é conservador); CONFERIR no livro físico.
    // PP:  1   5  10  15  20  25  30  35  40  45  50  60  65  70  75  80  85  90  95  99
    O1: [0, 11, 12, 14, 15, 16, 17, 18, 18, 19, 19, 21, 21, 22, 23, 24, 25, 26, 28, 30],
    O2: [0, 10, 13, 14, 15, 16, 16, 17, 18, 19, 19, 21, 21, 22, 23, 23, 24, 26, 27, 31],
    O3: [0, 13, 15, 15, 16, 17, 18, 18, 19, 19, 20, 21, 21, 22, 23, 23, 24, 25, 27, 29],
