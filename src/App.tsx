...
import Baralho from "./pages/exercicios/Baralho";
import Respiracao from "./pages/exercicios/Respiracao";
import Registro from "./pages/exercicios/Registro";
import Ancoragem from "./pages/exercicios/Ancoragem";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/exercicios/baralho" element={<Baralho />} />
        <Route path="/exercicios/respiracao" element={<Respiracao />} />
        <Route path="/exercicios/registro" element={<Registro />} />
        <Route path="/exercicios/ancoragem" element={<Ancoragem />} />
