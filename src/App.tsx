...
import SeparandoTudoPage from "./pages/exercicios/SeparandoTudoPage";
  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/exercicios/separando-tudo" element={<SeparandoTudoPage />} />
        <Route path="/exercicios/baloes-clima" element={<BaloesClimaPage />} />
